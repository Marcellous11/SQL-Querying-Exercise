...
-- SELECT rating,reviews FROM analytics 
-- WHERE rating > 4.8 
...
-- WHERE rating < 3 ORDER BY price desc 
...
-- SELECT category, COUNT(app_name) AS num_of_apps FROM analytics
--  GROUP BY category
...
-- SELECT app_name, reviews, min_installs, ROUND(min_installs/reviews,4) AS proportion FROM analytics 
